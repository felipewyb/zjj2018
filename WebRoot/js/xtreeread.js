...
WebFXTree.prototype.toString = function() {
	var str = "<div id=\"" + this.id + "\"  class=\"webfx-tree-item\" onkeydown=\"return webFXTreeHandler.keydown(this, event)\">" +
		...
		"<a href=# id=\"" + this.id + "-anchor\" text=\"" + this.text + "\" action=\"" + this.action + "\" onclick=\"op(this.text,this.action);\""+
		">" + this.text + "</a></div>" +
...
function op(text,id)
{    
   var mylen = id.indexOf("=");
   var alllen = id.length;
   id=id.substring(mylen+1,alllen);
   if(text=="Пе"){
   		text=" ";
   }
   var returnArray= new Array(id,text);
