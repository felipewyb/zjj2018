...
<div class="centercontent">
	<div class="custom_height_50 custom_line_height_50">
	     <span class="custom_float_left custom_padding_left_25 custom_color_lan_0099cc custom_font_size_16">修改设备类型</span>
	...
	<form class="stdform" id="editForm" name="editForm" action="matype_editsave.action" method="post">
	    <div class="custom_width_900 custom_min_height_250">   
	    <input type="hidden" name="obj.ttype" value="${obj.ttype }">
	        <p>
	            <label>设备类型：</label>
	            <span class="field"><input type="text"  class="smallinput" name="obj.tname" value="${obj.tname }" placeholder="设备类型"></span>
	        </p>
