   ...
   function DeleteMany(){ 
        ...
        <div class="custom_padding_15">
            <ul class="breadcrumbs custom_color_lan_0099cc custom_padding_4">
                <li><a href="" class="custom_font_size_14">子后台</a></li>
                <li><a href="" class="custom_font_size_14 custom_color_lan_0099cc">子后台角色分配</a></li>
            </ul>
        </div>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="stdtable stdtablecb" id="dyntable2">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="head0 " rowspan="1" colspan="1">角色id</th>
                            <th class="head0 " rowspan="1" colspan="1">角色名称</th>
                            <th class="head0 " rowspan="1" colspan="1">收益</th>
                    ...
                    <s:iterator value="list" var="t" status="i">
                        <tr>
                            ...
                            <td>${t.profit}</td>
                            <td>
                                <a href="<%= request.getContextPath() %>/backrole_editpage.action?id=${t.id}"  class="custom_a_cursor_pointer custom_margin_left_15 custom_color_lan_4477c0">修改</a>
                            </td>
                        </tr>
                     </s:iterator>  
                    </tbody>
