...
<div class="centercontent">
	...
	<form class="stdform" id="addForm" name="addForm" action="diqu_addsave.action" method="post">
	    <div class="custom_width_900 custom_min_height_250">   
	        <p>
	            <label>地区名称：</label>
	            <span class="field"><input type="text"  class="smallinput" name="obj.diquName" value="" placeholder="请添加地区名称"></span>
	        </p>
