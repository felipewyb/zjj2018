...
<div class="centercontent">
	...
	<form class="stdform" id="editForm" name="editForm" action="jiazhaoleixing_editsave.action" method="post">
	    <div class="custom_width_900 custom_min_height_250">   
	    <input type="hidden" name="obj.jaizhaoleixingId" value="${obj.jaizhaoleixingId }">
	        <p>
	            <label>驾照类型：</label>
	            <span class="field"><input type="text"  class="smallinput" name="obj.jaizhaoleixingName" value="${obj.jaizhaoleixingName }" placeholder="驾照类型"></span>
	        </p>
