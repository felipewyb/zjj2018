...
<div class="centercontent">
	<div class="custom_height_50 custom_line_height_50">
	     <span class="custom_float_left custom_padding_left_25 custom_color_lan_0099cc custom_font_size_16">修改驾照类型</span>
	     <a href="<%=basePath%>dengji_query.action" class="custom_width_height_50_50 custom_display_block custom_float_right custom_close custom_a_cursor_pointer" ></a>
	</div>
	<form class="stdform" id="editForm" name="editForm" action="dengji_editsave.action" method="post">
	    <div class="custom_width_900 custom_min_height_250">   
	    <input type="hidden" name="obj.sijiDengjiid" value="${obj.sijiDengjiid }">
	        <p>
	            <label>评定等级：</label>
	            <span class="field"><input type="text"  class="smallinput" name="obj.dengji" value="${obj.dengji }" placeholder="评定等级"></span>
	        </p>
	    </div>
