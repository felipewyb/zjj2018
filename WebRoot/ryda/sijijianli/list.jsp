                    ...
                    <s:iterator value="list" var="t" status="i">
                        <tr>
                          <td align="center" ><span class="center">
                          	<input type="checkbox"  name="ids" value="${t.sijijianliId }" ></span>
                          </td>
                            <td>${i.count}</td>
                            <td>${t.sijiXingming}</td>
                            <td>${t.sijiNianling}</td>
                            <td>${t.sijiSuoshudiqu}</td>
                            <td>${t.sijiJialing}</td>
                            <td><fmt:formatDate value="${t.sijiChushengriqi }" pattern="yyyy-MM-dd"/></td>
                            <td>${t.sijiShoujihao}</td>
                            <td>
                                <a href="<%= request.getContextPath() %>/siji_editpage.action?id=${t.sjid}"  class="custom_a_cursor_pointer custom_margin_left_15 custom_color_lan_4477c0">修改</a>
                                <a href="<%= request.getContextPath() %>/siji_deleteOne.action?id=${t.sjid}" class="custom_a_cursor_pointer custom_margin_left_15 custom_color_lan_4477c0">删除</a>
                            </td>
                        </tr>
                     </s:iterator>  
                    </tbody>
