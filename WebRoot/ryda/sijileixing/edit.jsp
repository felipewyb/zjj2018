...
<div class="centercontent">
	<div class="custom_height_50 custom_line_height_50">
	     <span class="custom_float_left custom_padding_left_25 custom_color_lan_0099cc custom_font_size_16">修改司机类型</span>
	     <a href="<%=basePath%>sijileixing_query.action" class="custom_width_height_50_50 custom_display_block custom_float_right custom_close custom_a_cursor_pointer" ></a>
	</div>
	<form class="stdform" id="editForm" name="editForm" action="sijileixing_editsave.action" method="post">
	    <div class="custom_width_900 custom_min_height_250">   
	    <input type="hidden" name="obj.sijileixigId" value="${obj.sijileixigId }">
	        <p>
	            <label>司机类型：</label>
	            <span class="field"><input type="text"  class="smallinput" name="obj.leixingName" value="${obj.leixingName }" placeholder="司机类型"></span>
	        </p>
