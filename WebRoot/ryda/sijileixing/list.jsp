...
<script type="text/javascript">
	...
	//添加
	function save(){
		location.href = "<%= request.getContextPath() %>/sijileixing_addpage.action";
	}
   //删除  
   function DeleteMany(){ 
        var flag=false;
   		...
   		if(!flag){
 			...
 			if(confirm("您确定要删除选中的吗？")==true){
 				...
 				document.form1.action = "<%= request.getContextPath() %>/sijileixing_deleteMany.action";
        ...
        <div class="custom_padding_15">
            <ul class="breadcrumbs custom_color_lan_0099cc custom_padding_4">
                <li><a href="" class="custom_font_size_14">司机管理</a></li>
                <li><a href="" class="custom_font_size_14 custom_color_lan_0099cc">司机类型</a></li>
            </ul>
        </div>
                    ...
                    <s:iterator value="list" var="t" status="i">
                        <tr>
                          <td align="center" ><span class="center">
                          	<input type="checkbox"  name="ids" value="${t.sijileixigId }" ></span>
                          </td>
                            <td>${i.count}</td>
                            <td>${t.leixingName}</td>
                            <td>
                                <a href="<%= request.getContextPath() %>/sijileixing_editpage.action?id=${t.sijileixigId}"  class="custom_a_cursor_pointer custom_margin_left_15 custom_color_lan_4477c0">修改</a>
                                <a href="<%= request.getContextPath() %>/sijileixing_deleteOne.action?id=${t.sijileixigId}" class="custom_a_cursor_pointer custom_margin_left_15 custom_color_lan_4477c0">删除</a>
                            </td>
                        </tr>
                     </s:iterator>  
                    </tbody>
